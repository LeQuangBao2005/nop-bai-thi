...
public class QLKhachHang {
    ...
    public boolean GhiHoaDon(String filename) {
        ...
        for (KhachHang kh : dsKhachHang) {
            String info = kh.getMaso() + ";" + kh.getHoten() + ";" + kh.getChisomoi() + ";" + kh.getChisomoi();
            input.add(info);
        }
    ...
    public void sapXepTheoLoaiHinh() {
      //sinh viên viết code    
        Comparator<KhachHang> cmp = (tieuthu1, tieuthu2) -> {
            return Double.compare(tieuthu1.getChisomoi(), tieuthu2.getChisocu());
        };
